...
MAINOBJS:=$(COREOBJS) blastem.o $(RENDEROBJS) zip.o  menu.o debug.o gdb_remote.o bindings.o oscilloscope.o movie.o control.o
...
TESTMOVIEOBJS:=testmovie.o movie.o serialize.o util.o io.o $(LIBZOBJS)
